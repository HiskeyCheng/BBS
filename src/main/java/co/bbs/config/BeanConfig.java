...
import co.bbs.module.user.service.GithubUserService;
import co.bbs.module.user.service.PersistentTokenService;
import co.bbs.module.user.service.UserService;
import co.bbs.web.secrity.YiiuUserDetailService;
