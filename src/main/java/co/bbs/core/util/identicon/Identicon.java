package co.bbs.core.util.identicon;

import co.bbs.config.SiteConfig;
import co.bbs.core.util.HashUtil;
import co.bbs.core.util.StrUtil;
import co.bbs.core.util.identicon.generator.IBaseGenartor;
import co.bbs.core.util.identicon.generator.impl.MyGenerator;
import co.bbs.core.util.security.MD5Helper;
